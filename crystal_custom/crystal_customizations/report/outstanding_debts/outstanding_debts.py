...
class CustomAgingWithPDC(ReceivablePayableReport):
	...
	def get_data(self, args):
		...
		# Get PDC amounts for all parties
		...
		for party, party_dict in self.party_total.items():
			...
			# Add PDC amount
			row.pdc = pdc_amounts.get(party, 0.0)

			# Calculate net outstanding (Outstanding - PDC)
			row.net_outstanding = flt(row.outstanding, self.currency_precision) - flt(row.pdc, self.currency_precision)
	...
	def get_columns(self):
		...
		# Add PDC column
		self.add_column(_("PDC (Post-Dated Checks)"), fieldname="pdc")
		
		# Add Net Outstanding column
		self.add_column(_("Net Outstanding"), fieldname="net_outstanding")
